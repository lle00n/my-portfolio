...
const BluePrint = () => {
  ...
  const blueprintInformationsRaw = t('blueprintInformations', { returnObjects: true });
const blueprintInformations = Array.isArray(blueprintInformationsRaw) ? blueprintInformationsRaw : [];
